...
namespace Velzon.Webs.Areas.Admin.Controllers
{
    ...
    public class JsMasterController : BaseController<JsMasterController>
    {
        ...
        [Route("/Admin/SaveJsData")]
        [HttpPost]
        public JsonResult SaveJsData([FromForm] JsMasterFormModel objModel)
        {
        ...
        [Route("/Admin/UpdateJsStatus")]
        [HttpPost]
        public JsonResult UpdateJsStatus(string id, int isActive)
        {
            JsonResponseModel objreturn = new JsonResponseModel();
            try
            {
                if (long.TryParse(Velzon.Common.Functions.FrontDecrypt(id), out long lgid))
                {
                    ...
                    {
                        objreturn = JsMasterService.UpdateStatus(lgid, UserModel.Username, isActive);
                    }
                    else
                    {
