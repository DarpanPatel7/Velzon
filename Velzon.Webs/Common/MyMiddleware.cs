...
namespace Velzon.Webs.Common
{
    public class MyMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            //string strPath = Velzon.Webs.Common.Functions.ValidateHomePage(mainPath);
            ...
            //{
            //    string strHomePath = Velzon.Webs.Common.Functions.GetHomePage();
            ...
            //string strPath = Velzon.Webs.Common.Functions.GetPathFrom(context.Request.Path.ToString());
