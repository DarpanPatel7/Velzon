...
namespace Velzon.Services.Service
{
    public class CMSTemplateMasterService : ICMSTemplateMasterService
    {
        ...
        public CMSTemplateModel Get(long id, long lgLangId=1)
        {
            ...
            {
                ErrorLogger.Error("Error Into cmsGetAllCMSTemplteMaster", ex.ToString(), "CMSTemplateMasterService", "Get");
                return null;
            }
        }
        ...
        public CMSTemplateModel GetByTemp(long id, long lgLangId = 1)
        {
            ...
            {
                ErrorLogger.Error("Error Into cmsGetAllCMSTemplteMaster", ex.ToString(), "CMSTemplateMasterService", "GetByTemp");
                return null;
            }
        }
        ...
        public List<CMSTemplateModel> GetList(long lgLangId=1)
        {
            try
            {
                ...
                var data= dapperConnection.GetListResult<CMSTemplateModel>("cmsGetAllCMSTemplteMaster", CommandType.StoredProcedure, dictionary).ToList();
                data.ForEach(x => {
            ...
            {
                ErrorLogger.Error("Error Into cmsGetAllCMSTemplteMaster", ex.ToString(), "CMSTemplateMasterService", "GetList");
                return null;
            }
        }
        ...
        public JsonResponseModel Delete(long id, string username)
        {
            ...
            try
            {
                ...
                dapperConnection.GetListResult<AdminMenuMasterModel>("cmsRemoveCMSTemplteMaster", CommandType.StoredProcedure, dictionary).FirstOrDefault();
            ...
            {
                ErrorLogger.Error("Error Into cmsRemoveCMSTemplteMaster", ex.ToString(), "CMSTemplateMasterService", "Delete");
        ...
        public JsonResponseModel AddOrUpdate(CMSTemplateModel model,string username)
        {
            ...
            try
            {
                ...
                var data = dapperConnection.GetListResult<long>("cmsInsertOrUpdateCMSTemplteMaster", CommandType.StoredProcedure, dictionary).FirstOrDefault();
            ...
            {
                ErrorLogger.Error("Error Into cmsInsertOrUpdateCMSTemplteMaster", ex.ToString(), "CMSTemplateMasterService", "AddOrUpdate");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
        ...
        public JsonResponseModel UpdateStatus(long id, string username, int isActive)
        {
            ...
            try
            {
                ...
                dictionary.Add("pUsername", username);
                dapperConnection.GetListResult<UserMasterModel>("cmsUpdateStatusCMSTemplteMaster", CommandType.StoredProcedure, dictionary).ToList();
            ...
            {
                ErrorLogger.Error("Error Into cmsUpdateStatusCMSTemplteMaster", ex.ToString(), "CMSTemplateMasterService", "UpdateStatus");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
