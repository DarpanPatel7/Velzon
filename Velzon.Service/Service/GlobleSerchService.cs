    ...
    public class GlobleSerchService: IGlobleSerchService
    {
        ...
        public List<GlobleSerchModel> GetList(string SearchText, long lgLangId)
        {
            ...
            {               
                ...
                var data = dapperConnection.GetListResult<GlobleSerchModel>("cmsGetAllMetaData", CommandType.StoredProcedure, dictionary).ToList();
               
                return data;
            }
            catch (Exception ex)
            {
                ErrorLogger.Error("Error Into cmsGetAllMetaData", ex.ToString(), "GlobleSerchService", "GetList");
                return null;
            }
        }
