...
namespace Velzon.Services.Service
{
    public class BannerService : IBannerService
    {
        ...
        public BannerModel Get(long id, long lgLangId = 1)
        {
            ...
            {
                ErrorLogger.Error("Error Into cmsGetAllBannerMaster", ex.ToString(), "BannerService", "Get");
                return null;
            }
        }
        ...
        public List<BannerModel> GetList(long lgLangId = 1)
        {
            try
            {
                ...
                var data = dapperConnection.GetListResult<BannerModel>("cmsGetAllBannerMaster", CommandType.StoredProcedure, dictionary).ToList();
                data.ForEach(x =>
                {
            ...
            {
                ErrorLogger.Error("Error Into cmsGetAllBannerMaster", ex.ToString(), "BannerService", "GetList");
                return null;
            }
        }

        public List<BannerModel> GetListFront(long lgLangId = 1)
        {
            try
            {
                Dictionary<string, object> dictionary = new Dictionary<string, object>();
                dictionary.Add("LangId", lgLangId);
                var data = dapperConnection.GetListResult<BannerModel>("frontGetAllBannerMaster", CommandType.StoredProcedure, dictionary).ToList();
                data.ForEach(x =>
                {
                    x.Id = (long)x.BannerId;
                });
            ...
            {
                ErrorLogger.Error("Error Into frontGetAllBannerMaster", ex.ToString(), "BannerService", "GetListFront");
                return null;
            }
        }
        ...
        public JsonResponseModel Delete(long id, string username)
        {
            ...
            try
            {
                ...
                dapperConnection.GetListResult<BannerModel>("cmsRemoveBannerMaster", CommandType.StoredProcedure, dictionary).FirstOrDefault();
            ...
            {
                ErrorLogger.Error("Error Into cmsRemoveBannerMaster", ex.ToString(), "BannerService", "Delete");
        ...
        public JsonResponseModel AddOrUpdate(BannerModel model, string username)
        {
            ...
            try
            {
                ...
                var data = dapperConnection.GetListResult<long>("cmsInsertOrUpdateBannerMaster", CommandType.StoredProcedure, dictionary).FirstOrDefault();
            ...
            {
                ErrorLogger.Error("Error Into cmsInsertOrUpdateBannerMaster", ex.ToString(), "BannerService", "AddOrUpdate");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
        ...
        public JsonResponseModel SwapSequance(long rank, string dir, string username)
        {
            ...
            using (var transactionScope = new TransactionScope())
            {
                ...
                {
                    ErrorLogger.Error("Error Into SwapSequance", ex.ToString(), "BannerService", "SwapSequance");
                    jsonResponseModel.strMessage = ex.Message;
                    jsonResponseModel.isError = true;
                    jsonResponseModel.type = PopupMessageType.error.ToString();
                }
        ...
        public JsonResponseModel UpdateStatus(long id, string username, int isActive)
        {
            ...
            try
            {
                ...
                dapperConnection.GetListResult<UserMasterModel>("cmsUpdateStatusBannerMaster", CommandType.StoredProcedure, dictionary).ToList();
            ...
            {
                ErrorLogger.Error("Error Into cmsUpdateStatusBannerMaster", ex.ToString(), "BannerService", "UpdateStatus");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
