    ...
    public class CMSMenuResourceMasterService : ICMSMenuResourceMasterService
    {
        ...
        public JsonResponseModel UpdateStatus(long id, string username, int isActive)
        {
            ...
            try
            {
                ...
                dictionary.Add("pUsername", username);
                dapperConnection.GetListResult<CMSMenuResourceModel>("cmsUpdateStatusCMSMenuResourceMaster", CommandType.StoredProcedure, dictionary).ToList();
            ...
            {
                ErrorLogger.Error("Error Into cmsUpdateStatusCMSMenuResourceMaster", ex.ToString(), "CMSMenuResourceMasterService", "UpdateStatus");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
