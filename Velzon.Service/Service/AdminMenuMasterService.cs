    ...
    public class AdminMenuMasterService : IAdminMenuMasterService
    {
        ...
        public JsonResponseModel UpdateStatus(long id, string username, int isActive)
        {
            ...
            try
            {
                ...
                dapperConnection.GetListResult<AdminMenuMasterModel>("cmsUpdateStatusAdminMenuMaster", CommandType.StoredProcedure, dictionary).ToList();
            ...
            {
                ErrorLogger.Error("Error Into cmsUpdateStatusAdminMenuMaster", ex.ToString(), "AdminMenuMasterService", "UpdateStatus");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
