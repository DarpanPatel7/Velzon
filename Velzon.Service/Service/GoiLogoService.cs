    ...
    public class GoiLogoService : IGoiLogoServices
    {
        ...
        public JsonResponseModel UpdateStatus(long id, string username, int isActive)
        {
            ...
            try
            {
                ...
                dictionary.Add("pUsername", username);
                dapperConnection.GetListResult<UserMasterModel>("cmsUpdateStatusGoiLogoMaster", CommandType.StoredProcedure, dictionary).ToList();
            ...
            {
                ErrorLogger.Error("Error Into cmsUpdateStatusGoiLogoMaster", ex.ToString(), "GoiLogoService", "UpdateStatus");
                jsonResponseModel.strMessage = ex.Message;
                jsonResponseModel.isError = true;
                jsonResponseModel.type = PopupMessageType.error.ToString();
            }
